/* Generated By:JavaCC: Do not edit this line. Reader2.java */
        import java.util.TreeMap;
        import java.util.Map;
        public class Reader2 implements Reader2Constants {
...
/**CircuitFerme*/
  ...
  /**CircuitFerme circuit*/
    ...
    while (true) {
      ...
      if (jj_2_1(10)) {
        indice = COMPOSANT(compo,sortie);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case P_OUVERT:
          indice = COMPOSITE(compo,type, sortie);
          break;
        default:
          jj_la1[1] = jj_gen;
          jj_consume_token(-1);
  ...
  final public int COMPOSANT($Composant compo,TreeMap <Integer,TreeMap<Integer,Integer>> sortie) throws ParseException, Exception {
        int nb_sorties;
        int nb_entrees;
        int port;
        int indice;
...
/**"<".NUM."|".TYPE."(".NUM.",".NUM.")"."[".SORTIE_ENTRE.COMPOSANT."]".[ID]."->".SORTIE_ENTRE.">"*/
  final public int COMPOSITE($Composant compo,String type,TreeMap <Integer,TreeMap<Integer,Integer>> connexionSortie) throws ParseException, Exception {
        int nb_sorties;
        int nb_entrees;
        int indiceCompo = 0;
        int numPort = 0;
  ...
  public Reader2TokenManager token_source;
  ...
  public Reader2(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Reader2(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Reader2TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Reader2(java.io.Reader stream) {
  ...
  public Reader2(Reader2TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Reader2TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
