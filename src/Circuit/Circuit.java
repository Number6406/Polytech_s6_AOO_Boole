...
public class Circuit implements _Circuit {
	...
	/**
	 * Fonction permettant de connecter deux composant dans un circuit via leurs numÈros de port.
	 ...
	 * @param numComposantSortie NumÈro du composant dont on veut la sortie
	 * @param numPortSortie Port de sortie de numComposantSortie ‡ connecter
	 * @param numComposantEntree NumÈro du composant en entrÈe
	 * @param numPortEntree Port d'entrÈe de numComposantEntree ‡ connecter
	 */
	 ...
	 * @return true : le circuit est Èvaluable, false : le circuit n'est pas Èvaluable.
	 */
	...
	/**
	 * Fonction permettant de rÈcuperer un composant ‡ partir de son numÈro dans un circuit.
